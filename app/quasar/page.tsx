...
export default function Quasar() {
  if (typeof localStorage !== "undefined") {
      ...
      return (
        <main className={styles.main}>
          <div className={styles.instructionsDiv}>
            ...
            <br />
            <p>
              Quasar is played by adding a random number to your score,
              allocated between set values. You have two options, either to
              select a random number between 1 and 8 or a random number between
              4 and 7. The goal is to get as close to 20 in your score without
              going over. The payout for each number, starting at 17, are as
              follows:{" "}
            </p>
            ...
            <br />
            <p>
              Based on the casino game Quasar from the Mass Effect series,
              created by BioWare!
            </p>
          </div>
          <div
    ...
    return <h1>Something went wrong, please contact site owner!</h1>;
  }
}
